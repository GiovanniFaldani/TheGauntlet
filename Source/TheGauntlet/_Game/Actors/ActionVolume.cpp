...
#include "_Game/Actors/ActionVolume.h"
#include "../CPP_GameModeBase.h"
#include "../CPP_Character.h"

// Sets default values
AActionVolume::AActionVolume()
{
...
void AActionVolume::BeginPlay()
{
	Super::BeginPlay();
	
    // Bind my custom function to trigger box on begin overlap event
    TriggerBox->OnComponentBeginOverlap.AddDynamic(this, &AActionVolume::OnOverlapBegin);
}

void AActionVolume::OnOverlapBegin(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
...
// Called every frame
void AActionVolume::Tick(float DeltaTime)
{
